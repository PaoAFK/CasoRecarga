        ...
        <div class="col-12">
                ...
                <table class="table">
                        <thead>
                                <tr class="filters ">
                                        <th class="col-9">
                                                <h3 class="card-title">Recargas</h4>
                                        </th>
                                        <th class="col-3">
                                                <div class="d-grid gap-2 mx-auto">
                                                <a class="btn btn-primary" href="crear.php" role="button" style="background-color: green; color: white;">Nueva recarga</a>
                                                </div>
                                        </th>
                                </tr>
                        </thead>
                ...
                $query ="SELECT * FROM recarga WHERE 1=1";                                                         
                ...
                <table class="table ">
                        <thead>
                                <tr style="background-color:purple; color:#FFFFFF;">
                                        ...
                                        <th style=" text-align: center;"> Id Jugador </th>
                        ...
                        <?php While($rowSql = $sql->fetch_assoc()) {   ?>
                                ...
                                <td style="text-align: center;"><?php echo $rowSql["idJugador"]; ?></td>
                                <td style="text-align: center;"><?php echo $rowSql["fecha"]; ?></td>
                                <td style="text-align: center;"><a class="text-success" href="editar.php?id=<?php echo $rowSql["id"]; ?>"><i class="bi bi-pencil-square" ></i></a></td>
